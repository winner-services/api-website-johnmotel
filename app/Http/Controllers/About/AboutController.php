...
class AboutController extends Controller
{
     ...
     *    @OA\JsonContent(
     *       required={"Hotel_name","title_en","title_fr","short_description_en","short_description_fr","adress_en","adress_fr","facebook","instagram","linkedin","twitter","email","phone","youtube","image1","image2"},
     ...
     *    @OA\JsonContent(
     *       required={"mission_en","mission_fr","vision_en","vision_fr","objectif_en","objectif_fr","title_en","title_fr","short_description_en","short_description_fr","adress_en","adress_fr","facebook","instagram","linkedin","twitter","email","phone","sloga_en","sloga_fr"},
     *       @OA\Property(property="mission_en", type="string", format="text"),
     *       @OA\Property(property="mission_fr", type="string", format="text"),
     *       @OA\Property(property="vision_en", type="string", format="text"),
     *       @OA\Property(property="vision_fr", type="string", format="text"),
     *       @OA\Property(property="objectif_en", type="string", format="text"),
     *       @OA\Property(property="objectif_fr", type="string", format="text"),
     *       @OA\Property(property="title_en", type="string", format="text"),
     *       @OA\Property(property="title_fr", type="string", format="text"),
     *       @OA\Property(property="short_description_en", type="string", format="text"),
     *       @OA\Property(property="short_description_fr", type="string", format="text"),
     *       @OA\Property(property="adress_en", type="string", format="text"),
     *       @OA\Property(property="adress_fr", type="string", format="text"),
     *       @OA\Property(property="facebook", type="string", format="text"),
     *       @OA\Property(property="instagram", type="string", format="text"),
     *       @OA\Property(property="linkedin", type="string", format="text"),
     *       @OA\Property(property="twitter", type="string", format="text"),
     *       @OA\Property(property="email", type="string", format="text"),
     *       @OA\Property(property="phone", type="string", format="text"),
     *       @OA\Property(property="sloga_en", type="string", format="text"),
     *       @OA\Property(property="sloga_fr", type="string", format="text"),
     *       @OA\Property(property="image1", type="string", format="text"),
     *       @OA\Property(property="image2", type="string", format="text")
     *    ),
     * ),
     * @OA\Response(
     *    response=200,
